...
// TODO: AddAccountModel is using if necessary informations about user account model: Example: {name, email, password} not passing id of User.
...
describe('SignUp Controller', () => {
  ...
  test('Should call AddAccounbt with correct values', async () => {
  ...
  test('Should return 200 if valid is provide', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'valid_name',
